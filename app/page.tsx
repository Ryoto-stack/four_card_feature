...
export default function Home() {
  return (
    <div className=" flex w-full h-full items-center justify-center p-10 ">
      <main className=" w-[1400px] h-[850px] flex items-center justify-center flex-col">
        <div className=" flex-col flex items-center">
          <div className="text-4xl">
            <h1>Reliable, Efficient delivery</h1>
            <h1 className="font-bold">Powered by Technology</h1>
          </div>
          <p className="w-[500px] text-center mt-5">
        ...
        <div className="flex flex-row  w-full h-screen  items-center justify-center">
          <div
            className="w-[400px] h-[300px] border-t-4 drop-shadow-2xl bg-white border-cyan-500 mr-5 p-7 justify-between rounded-xl flex flex-col"
            id="1st"
          >
          ...
          <div
            className="w-[400px] h-full  drop-shadow-2xl  flex flex-col items-center justify-center"
            id="1st"
          >
            <div className="w-[400px] h-[300px] border-t-4 border-red-500 mb-5 rounded-xl bg-white p-7 flex justify-between flex-col">
              <div className="flex justify-between flex-col ">
                <h1 className="text-xl font-bold text-slate-700 mb-5">
                  Team Builder
                </h1>
                <p className="pr-8 ">
                  Scans our talent network to create the optimal team for you
                  project
                </p>
              </div>
              <div className="flex w-full justify-end">
            ...
            <div className="w-[400px] h-[300px]  border-orange-500 border-t-4 mb-5 rounded-xl bg-white p-7 flex justify-between flex-col">
              <div className="flex justify-between flex-col ">
                <h1 className="text-xl font-bold text-slate-700 mb-5">Karma</h1>
                <p className="pr-8 ">
                  Regulary evaluates our talen to ensure quality
                </p>
              </div>
              <div className="flex w-full justify-end">
                <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64">
          ...
          <div
            className="w-[400px] h-[300px]   ml-5 rounded-xl"
            id="1st"
          >
            <div className="w-[400px] h-[300px] drop-shadow-2xl  border-blue-500 border-t-4 mb-5 rounded-xl bg-white p-7 flex justify-between flex-col">
              <div className="flex justify-between flex-col ">
                <h1 className="text-xl font-bold text-slate-700 mb-5">
                  Calculator
                </h1>
